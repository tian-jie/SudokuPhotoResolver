...
def test_mobilenet():
    ...
    # todo 加载模型，修改为你的模型名称
    model = tf.keras.models.load_model("data/models/mobilenet_fv.h5")
    # model.summary()
    # 测试
    ...
    show_heatmaps(title="heatmap", x_labels=class_names, y_labels=class_names, harvest=heat_maps_float,
                  save_name="data/results/heatmap_mobilenet.png")
...
def test_cnn():
    ...
    # todo 加载模型，修改为你的模型名称
    model = tf.keras.models.load_model("data/models/cnn_fv.h5")
    ...
    # title, x_labels, y_labels, harvest
    show_heatmaps(title="heatmap", x_labels=class_names, y_labels=class_names, harvest=heat_maps_float,
                  save_name="data/results/heatmap_cnn.png")
